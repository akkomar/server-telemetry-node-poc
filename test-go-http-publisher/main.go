...
func main() {
	...
	// To generate the code under `glean/server_events.go`, check out the go_http branch of glean_parser (https://github.com/mozilla/glean_parser/pull/827) and run:
	// glean_parser translate tests/data/server_metrics_with_event.yaml -f go_server_http -o ../server-telemetry-node-poc/test-go-http-publisher/glean
	//
	// ============================================================================
