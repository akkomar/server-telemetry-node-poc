...
// AUTOGENERATED BY glean_parser v14.3.1.dev3+g0d7fb81e. DO NOT EDIT.
...
func (g GleanEventsLogger) createClientInfo() clientInfo {
	...
	return clientInfo{
		TelemetrySDKBuild: "glean_parser v14.3.1.dev3+g0d7fb81e",
...
func (g GleanEventsLogger) RecordEventBackendObjectUpdate(
	...
	var extraKeys = map[string]string{
		...
		"linking": fmt.Sprintf("%t", params.Linking),
	}
