...
pub struct BackendObjectUpdateEvent {
    ...
    pub object_type: String, // A simple name to describe the object whose state changed. For example, `api_request`.
    pub object_state: String, // A JSON representation of the latest state of the object.
    pub linking: bool, // Indicates the initial linking of the Mozilla account and the third-party account.
}

// Implementing the EventsPingEvent trait for the generated struct BackendObjectUpdateEvent
impl EventsPingEvent for BackendObjectUpdateEvent {
    /// Create a GleanEvent for the above-defined Event struct (BackendObjectUpdateEvent).
...
pub struct EventsPing {
    pub identifiers_fxa_account_id: String, // The user's FxA account ID, if available.
